...
Security fixes are provided for **currently supported release lines** of `switon/cli` (`switon/cli` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/cli/security/advisories/new)
